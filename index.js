// Shared build utilities and app-level exports from the co-bundled config chunk.
// The names here are Vite's minified aliases; the comments give the original meanings.
import {
  a as e, // useRoutes         — react-router-dom hook (renders matched routes)
  c as t, // __modulePreload   — Vite's modulepreload fetch helper
  d as n, // __toESM           — wraps a CommonJS default export for ESM callers
  i as r, // useNavigate       — react-router-dom hook (programmatic navigation)
  l as i, // __commonJS        — wraps a CommonJS module factory (lazy init + cache)
  n as a, // appRoutes         — the route config array [{ path, element }, ...]
  o, // jsxRuntime        — CommonJS-wrapped react/jsx-runtime module
  r as s,
  s as c,
  u as l,
} from "./config.js";
...
// ============================================================
// SECTION 1: Vite Module Preload Polyfill
// Ensures <link rel="modulepreload"> works in all browsers
// ============================================================
(function () {
  ...
  function n(e) {
    ...
    // Intercepts console.error and window error events, collects
    // runtime errors for reporting to the parent (preview iframe)
    // ============================================================
    if (e.ep) return;
    e.ep = !0;
    let n = t(e);
...
function g(e) {
  try {
    ...
    if (t && t.stack) p({ type: `console.error`, args: t });
    else if (e.length > 0) {
      let t = e
        .map((e) => (typeof e == `object` ? JSON.stringify(e) : String(e)))
        .join(` `);
      p({ type: `console.error`, args: Error(t) });
    }
  } catch (e) {
    console.warn(e);
  }
...
var v = 1e3,
  // ============================================================
  // SECTION 3: PostMessage IPC + Interaction Detection
  // S class: bidirectional postMessage channel between iframe/parent
  // ee: DOM event listener tracker (tracks click, touch, pointer events)
  // Exports: hasInteractionEvents, checkBySelector, checkByPoint, etc.
  // ============================================================
  ...
  S = class {
    ...
    post(e, t, n) {
      ...
      return (
        this.client.postMessage({ data: t, id: b, type: e }, i),
        new Promise((e) => {
          (this.waitRes.set(b, (t) => {
            e(t);
          }),
            setTimeout(() => {
              (this.waitRes.delete(b), e(y));
            }, r || this.baseTimeout));
        })
      );
    }
    on(e, t, n) {
      let { once: r, origin: i = x } = n || {},
        a = async (n) => {
          let { id: a, type: s, data: c } = n.data,
            l;
          s === e &&
            ((l = await t(c)),
            console.log(e, r, l, c),
            ((a && i === n.origin) || i === x) &&
              n.source?.postMessage({ fromType: e, id: a, data: l }, n.origin),
            r && o());
        };
      ...
      return (this.removeListeners.add(o), o);
    }
    emitResponse(e) {
  ...
  ee = new (class {
    ...
    patch() {
      ...
      ((HTMLElement.prototype.addEventListener = function (t, n, r) {
        return (e.#i(this, t, n), e.#t.call(this, t, n, r));
      }),
        (HTMLElement.prototype.removeEventListener = function (t, n, r) {
          return (e.#a(this, t, n), e.#n.call(this, t, n, r));
        }),
        (this.#r = !0),
    ...
    unpatch() {
      this.#r &&
        ((HTMLElement.prototype.addEventListener = this.#t),
    ...
    #i(e, t, n) {
      let r = this.#e.get(e);
      r || ((r = new Map()), this.#e.set(e, r));
      let i = r.get(t);
      (i || ((i = new Set()), r.set(t, i)), i.add(n));
    }
    #a(e, t, n) {
      let r = this.#e.get(e);
      if (!r) return;
      let i = r.get(t);
      i && (i.delete(n), i.size === 0 && r.delete(t));
    }
    hasListeners(e, t) {
      let n = this.#e.get(e);
      return !n || n.size === 0
    ...
    getElementDebugInfo(e) {
      ...
      return t
        ? {
            ...
            totalListeners: Array.from(t.values()).reduce(
              (e, t) => e + t.size,
              0,
            ),
          }
        : { element: e, hasListeners: !1, eventTypes: [], totalListeners: 0 };
    }
  })(),
  te = [
    `click`,
...
function ne(e) {
  return ee.hasListeners(e, te);
}
function C(e) {
  return ee.getEventTypes(e).filter((e) => te.includes(e));
}
function re(e) {
  let t = C(e),
    n = {};
  return (
    t.forEach((t) => {
      n[t] = ee.getListenerCount(e, t);
    }),
    { hasEvents: t.length > 0, eventTypes: t, listeners: n }
  );
}
function ie(e) {
  return ee.getElementDebugInfo(e);
}
function ae(e = window) {
  (ee.patch(),
    (e.__eventListenerRegistry__ = {
      hasListeners: ne,
      getEventTypes: C,
      getDetail: re,
      getDebugInfo: () => ee.getDebugInfo(),
      getElementDebugInfo: ie,
    }),
    console.log(
...
function se(e) {
  let t = Object.keys(e).find(
    (e) =>
      e.startsWith(`__reactFiber$`) || e.startsWith(`__reactInternalInstance$`),
  );
  return t ? e[t] : null;
}
function ce(e) {
  return !e || typeof e != `object`
    ? !1
    : oe.some((t) => typeof e[t] == `function`);
}
function le(e) {
  return !e || typeof e != `object`
    ? []
    : oe.filter((t) => typeof e[t] == `function`);
}
function w(e) {
  let t = se(e);
  for (; t; ) {
    if (t.memoizedProps && ce(t.memoizedProps)) return !0;
    t = t.return || null;
  }
  return !1;
}
function T(e) {
  let t = { hasEvents: !1, events: [] },
    n = se(e);
  for (; n; ) {
    if (n.memoizedProps) {
      let e = le(n.memoizedProps);
      if (e.length > 0) {
        t.hasEvents = !0;
        let r =
          n.type?.displayName ||
...
function ue(e) {
  let t = se(e);
  return !t || !t.memoizedProps ? !1 : ce(t.memoizedProps);
}
function de(e = window) {
  ((e.__reactEventDetector__ = {
    hasReactInteractionEvents: w,
    getReactInteractionEventsDetail: T,
    hasReactInteractionEventsOnSelf: ue,
    REACT_EVENT_PROPS: oe,
  }),
    console.log(
      `[ReactEventDetector] Injected to window.__reactEventDetector__`,
    ));
}
...
function pe(e) {
  return e ? ue(e) || ne(e) : !1;
}
function E(e) {
  let t = T(e),
    n = re(e);
  return { hasEvents: t.hasEvents || n.hasEvents, react: t, native: n };
}
function D(e) {
  if (!e) return { error: `selector is required` };
  let t = document.querySelector(e);
  return t
    ? { selector: e, hasEvents: E(t).hasEvents }
    : { error: `Element not found`, selector: e };
}
function me(e, t) {
  ...
  return n
    ? { x: e, y: t, hasEvents: E(n).hasEvents }
    : { error: `No element at point`, x: e, y: t };
}
function he(e) {
  return e.map((e) => ({ element: e, hasEvents: fe(e) }));
}
function ge(e) {
  return e.map((e) => ({ selector: e, result: D(e) }));
}
var _e = `1.0.0`;
function ve() {
  ((window.__interactionDetector__ = {
    hasInteractionEvents: fe,
    hasInteractionEventsOnSelf: pe,
    getDetail: E,
    checkBySelector: D,
    checkByPoint: me,
    checkMultiple: he,
    checkMultipleSelectors: ge,
    version: _e,
  }),
    console.log(`[InteractionDetector] Global API initialized (v${_e})`));
}
function ye() {
  let e = new S(window.parent);
...
function be() {
  // ============================================================
  // SECTION 4: source-map Library (v0.7.x)
  // Base64 VLQ encoding, SourceMapGenerator, SourceMapConsumer,
  // SourceNode — used to map minified stack traces to source positions
  // ============================================================
  (ae(), de(), ve(), ye(), console.log(`[Continue] Module fully initialized`));
}
var xe = i((e) => {
    var t =
  ...
  Se = i((e) => {
    ...
    e.encode = function (e) {
      let r = ``,
        s,
        c = o(e);
      do ((s = c & i), (c >>>= n), c > 0 && (s |= a), (r += t.encode(s)));
      while (c > 0);
      return r;
    };
  }),
  ...
  we = i((e, t) => {
    t.exports = typeof URL == `function` ? URL : Ce().URL;
  }),
  Te = i((e) => {
    var t = we();
    function n(e, t, n) {
    ...
    function v(e, n) {
      ...
      let r = n.pathname.split(`/`),
        i = e.pathname.split(`/`);
      for (
        i.length > 0 && !i[i.length - 1] && i.pop();
        r.length > 0 && i.length > 0 && r[0] === i[0];
      )
        (r.shift(), i.shift());
      return (
        i
    ...
    function S(e, t) {
      let n = _(t),
        r = _(e);
      if (((e = y(e)), n === `absolute`)) return p(t, void 0);
      if (r === `absolute`) return p(t, e);
      if (n === `scheme-relative`) return x(t);
      if (r === `scheme-relative`) return p(t, p(e, d)).slice(5);
      if (n === `path-absolute`) return x(t);
      if (r === `path-absolute`) return p(t, p(e, d)).slice(d.length);
      let i = h(t + e);
    ...
    function te(e, n) {
      ...
      return a.protocol !== i.protocol ||
        a.user !== i.user ||
        a.password !== i.password ||
        a.hostname !== i.hostname ||
        a.port !== i.port
        ? null
        : v(i, a);
    }
    function ne(e, t, n) {
      ...
      let r = x(t || ``);
      return (e && (r = S(e, r)), n && (r = S(b(n), r)), r);
    }
    e.computeSourceURL = ne;
  }),
  Ee = i((e) => {
    e.ArraySet = class e {
      constructor() {
      ...
      static fromArray(t, n) {
        let r = new e();
        for (let e = 0, i = t.length; e < i; e++) r.add(t[e], n);
        return r;
      }
      size() {
  ...
  De = i((e) => {
    ...
    function n(e, n) {
      ...
      return (
        i > r ||
        (i == r && o >= a) ||
        t.compareByGeneratedPositionsInflated(e, n) <= 0
      );
    }
    e.MappingList = class {
      constructor() {
      ...
      toArray() {
        return (
          (this._sorted ||=
            (this._array.sort(t.compareByGeneratedPositionsInflated), !0)),
          this._array
        );
      }
    };
  ...
  Oe = i((e) => {
    var t = Se(),
      ...
      a = class e {
        ...
        static fromSourceMap(t) {
          let r = t.sourceRoot,
            i = new e({ file: t.file, sourceRoot: r });
          return (
        ...
        _serializeMappings() {
          ...
          for (let m = 0, h = p.length; m < h; m++) {
            if (((u = p[m]), (l = ``), u.generatedLine !== r))
              for (e = 0; u.generatedLine !== r; ) ((l += `;`), r++);
            else if (m > 0) {
              if (!n.compareByGeneratedPositionsInflated(u, p[m - 1])) continue;
              l += `,`;
            }
    ...
    ((a.prototype._version = 3), (e.SourceMapGenerator = a));
  }),
  ke = i((e) => {
  ...
  Ae = i((e, t) => {
    var n = null;
    ((t.exports = function () {
      if (typeof n == `string`) return fetch(n).then((e) => e.arrayBuffer());
      if (n instanceof ArrayBuffer) return Promise.resolve(n);
      throw Error(
  ...
  Me = i((e) => {
    ...
    var c = class e extends s {
      constructor(e, n) {
        return super(o).then((i) => {
          ...
          if (s != i._version) throw Error(`Unsupported version: ` + s);
          return (
            (i._sourceLookupCache = new Map()),
            (i._names = r.fromArray(l.map(String), !0)),
            (i._sources = r.fromArray(c, !0)),
            (i._absoluteSources = r.fromArray(
              i._sources.toArray().map(function (e) {
      ...
      _findSourceIndex(e) {
        ...
        if (this._absoluteSources.has(r)) {
          ...
          return (this._sourceLookupCache.set(e, t), t);
        }
      ...
      _getMappingsPtr() {
        return (
          this._mappingsPtr === 0 && this._parseMappings(),
          this._mappingsPtr
        );
      }
      _parseMappings() {
      ...
      eachMapping(e, t, n) {
        ...
        this._wasm.withMappingCallback(
          (t) => {
            (t.source !== null &&
              ((t.source = this._absoluteSources.at(t.source)),
              t.name !== null && (t.name = this._names.at(t.name))),
              this._computedColumnSpans &&
                t.lastGeneratedColumn === null &&
      ...
      allGeneratedPositionsFor(e) {
        ...
        if (r < 1) throw Error(`Line numbers must be >= 1`);
        if (i < 0) throw Error(`Column numbers must be >= 0`);
        let a = [];
        return (
          this._wasm.withMappingCallback(
            (e) => {
      ...
      computeColumnSpans() {
        this._computedColumnSpans ||=
          (this._wasm.exports.compute_column_spans(this._getMappingsPtr()), !0);
      }
      originalPositionFor(e) {
        ...
        if (n.generatedLine < 1) throw Error(`Line numbers must be >= 1`);
        if (n.generatedColumn < 0) throw Error(`Column numbers must be >= 0`);
      ...
      generatedPositionFor(e) {
        ...
        if (r.originalLine < 1) throw Error(`Line numbers must be >= 1`);
        if (r.originalColumn < 0) throw Error(`Column numbers must be >= 0`);
        ...
        if (
          ...
          return (
            this._computedColumnSpans && e === null && (e = 1 / 0),
            {
    ...
    ((c.prototype.consumer = s), (e.BasicSourceMapConsumer = c));
    var l = class extends s {
      constructor(e, n) {
        return super(o).then((r) => {
          ...
          if (a != r._version) throw Error(`Unsupported version: ` + a);
          let c = { line: -1, column: 0 };
          return Promise.all(
            o.map((e) => {
              if (e.url)
                throw Error(
        ...
        let r = {
          ...
          i = n.search(r, this._sections, function (e, t) {
            return (
              ...
              e.generatedColumn - (t.generatedOffset.generatedColumn - 1)
            );
          }),
          a = this._sections[i];
        return a
      ...
      _findSectionIndex(e) {
        for (let t = 0; t < this._sections.length; t++) {
          ...
          if (n._findSourceIndex(e) !== -1) return t;
        }
        return -1;
      }
      generatedPositionFor(e) {
        ...
        if (a && a.line !== null) {
          ...
          return (
            ...
            a.lastColumn === 1 / 0 &&
              i &&
              a.line === i.generatedOffset.generatedLine &&
              (a.lastColumn = i.generatedOffset.generatedColumn - 2),
            (a.line += e),
            a
          );
        }
        ...
        let n = this._findSectionIndex(t.getArg(e, `source`)),
          ...
          i =
            n >= 0 && n + 1 < this._sections.length
              ...
              : null;
        return r
          ? r.consumer.allGeneratedPositionsFor(e).map((e) => {
              ...
              return (
                ...
                e.lastColumn === 1 / 0 &&
                  i &&
                  e.line === i.generatedOffset.generatedLine &&
                  (e.lastColumn = i.generatedOffset.generatedColumn - 2),
                (e.line += t),
                e
              );
            })
      ...
      eachMapping(e, t, n) {
        this._sections.forEach((r, i) => {
          ...
          r.consumer.eachMapping(
            function (t) {
              (t.generatedLine === 1 &&
                ((t.generatedColumn += c),
                typeof t.lastGeneratedColumn == `number` &&
                  (t.lastGeneratedColumn += c)),
                t.lastGeneratedColumn === 1 / 0 &&
                  a &&
                  t.generatedLine === a.generatedOffset.generatedLine &&
                  (t.lastGeneratedColumn =
                    a.generatedOffset.generatedColumn - 2),
                (t.generatedLine += s),
                e.call(this, t));
            },
            t,
  ...
  Ne = i((e) => {
    ...
    e.SourceNode = class e {
      ...
      static fromStringWithSourceMap(t, i, a) {
        ...
        return (
          i.eachMapping(function (e) {
            if (f !== null)
              if (u < e.generatedLine) (m(f, l()), u++, (d = 0));
              else {
                p = s[c] || ``;
          ...
          c < s.length && (f && m(f, l()), o.add(s.splice(c).join(``))),
          i.sources.forEach(function (e) {
            let t = i.sourceContentFor(e);
            t != null &&
              (a != null && (e = n.join(a, e)), o.setSourceContent(e, t));
          }),
          o
        );
        function m(t, r) {
          if (t === null || t.source === void 0) o.add(r);
          else {
      ...
      add(e) {
        ...
        else if (e[a] || typeof e == `string`) e && this.children.push(e);
        else
          throw TypeError(
      ...
      prepend(e) {
        ...
        else if (e[a] || typeof e == `string`) this.children.unshift(e);
        else
          throw TypeError(
            `Expected a SourceNode, string, or an array of SourceNodes and strings. Got ` +
              e,
  ...
  Pe = i((e) => {
    ((e.SourceMapGenerator = Oe().SourceMapGenerator),
      (e.SourceMapConsumer = Me().SourceMapConsumer),
      (e.SourceNode = Ne().SourceNode));
  })();
function Fe(e, t, n) {
  let r = e[t];
  if (!r) return { lineIndex: t, column: n };
  let i = r.trim(),
  ...
  if (a || o || s) {
    if (n != null) {
      // ============================================================
      // SECTION 5: Error Overlay & Source Map Integration
      // Maps runtime error stack frames back to JSX source positions
      // using the source-map library. Sends errors to parent iframe.
      // ============================================================
      let e = r.substring(n),
        i = e.match(/<([A-Za-z][A-Za-z0-9\-_.]*)/);
      if (i && e[i.index + 1] !== `/`)
        return { lineIndex: t, column: n + i.index + 1 };
    }
    for (let n = t + 1; n < e.length && n < t + 50; n++) {
      let t = e[n],
        r = t.match(/<([A-Za-z][A-Za-z0-9\-_.]*)/);
      if (r && t[r.index + 1] !== `/`)
        return { lineIndex: n, column: r.index + 1 };
    }
  }
  return { lineIndex: t, column: n };
}
function Ie(e, t, n) {
  let r = 0;
  for (let i = t; i < e.length; i++) {
    ...
    for (let e = o; e < a.length; e++) {
      ...
      if (t === `{`) r++;
        ...
        if (t === `/` && a[e + 1] === `>`)
          return { lineIndex: i, columnEnd: e + 2, isSelfClosing: !0 };
        if (t === `>`)
          return { lineIndex: i, columnEnd: e + 1, isSelfClosing: !1 };
      }
    }
  }
}
function Le(e, t, n, r) {
  ...
  for (let t = n; t < e.length; t++) {
    ...
    for (a.lastIndex = 0; (u = a.exec(c)) !== null; ) {
      let e = Ie([c], 0, u.index + u[0].length);
      e &&
        !e.isSelfClosing &&
        l.push({ type: `open`, index: u.index, length: u[0].length });
    }
    for (o.lastIndex = 0; (u = o.exec(c)) !== null; )
      l.push({ type: `close`, index: u.index, length: u[0].length });
    l.sort((e, t) => e.index - t.index);
    for (let e of l)
      if (e.type === `open`) i++;
      else if (e.type === `close` && (i--, i === 0))
        return { lineIndex: t, columnEnd: s + e.index + e.length };
  }
}
function Re(e, t, n) {
  let r;
  for (let i = t; i >= 0; i--) {
    ...
    for (; (s = o.exec(a)) !== null; ) {
      ...
      let d = i,
        f = u.columnEnd;
      if (!u.isSelfClosing) {
        let t = Le(e, c, i, u.columnEnd);
        if (!t) continue;
        ((d = t.lineIndex), (f = t.columnEnd));
      }
      (i < t || (i === t && o <= (n ?? a.length))) &&
        (d > t || (d === t && f >= (n ?? 0))) &&
        (!r ||
          d - i < r.closeLineIndex - r.lineIndex ||
          (d - i === r.closeLineIndex - r.lineIndex &&
            f - o < r.closeColumnEnd - r.columnStart)) &&
        (r = {
          tagName: c,
          lineIndex: i,
          columnStart: o,
  ...
  for (let n = t + 1; n < e.length && n < t + 50; n++) {
    ...
    if (i) {
      ...
      let s = n,
        c = o.columnEnd;
      if (!o.isSelfClosing) {
        let t = Le(e, r, n, o.columnEnd);
        if (!t) continue;
        ((s = t.lineIndex), (c = t.columnEnd));
      }
      return {
        tagName: r,
        lineIndex: n,
...
function Be(e, t, n, r, i) {
  if (t === r) return e[t].substring(n, i);
...
async function He(e) {
  try {
    let t = await fetch(e);
    if (!t.ok) throw Error(`Failed to load source map: ${t.status}`);
    return await t.json();
  } catch (t) {
...
setInterval(() => {
  let e = Date.now();
  for (let [t, n] of O.entries()) e - n.timestamp > We && O.delete(t);
}, 6e4);
async function Ke() {
  if (!Ue)
    try {
      (await Pe.SourceMapConsumer.initialize({
      ...
      try {
        (await Pe.SourceMapConsumer.initialize({}), (Ue = !0));
      } catch (e) {
        throw (
          console.error(
...
function qe(e) {
  if (!e || !e.stack) return `no-stack-${e?.message || `unknown`}`;
  let t = e.stack
    .split(
      `
`,
...
var Je = `preview-inject/`;
async function Ye(e, t = 10, n) {
  if (!e || !e.stack)
    return {
  ...
  if (O.has(r)) {
    let e = O.get(r);
    return (console.log(`Using cached error mapping for:`, r), e);
  }
  if (O.size >= Ge) return null;
  await Ke();
  let i = e.stack.split(`
`),
    a = [],
  ...
  for (let e of i) {
    ...
    let i, u, d, f;
    r[1]
      ? ((i = r[1]), (u = r[2]), (d = parseInt(r[3])), (f = parseInt(r[4])))
      : r[5]
        ? ((i = `<anonymous>`),
          (u = r[5]),
          (d = parseInt(r[6])),
    ...
    try {
      let r = `${u}.map`,
        p = s.get(r);
      p || ((p = await new Pe.SourceMapConsumer(await He(r))), s.set(r, p));
      let m = p.originalPositionFor({ line: d, column: f });
      if (m.source) {
        if (m.source.includes(Je)) continue;
        let e = m.source
            .split(`/`)
            .filter((e) => e !== `..`)
            .join(`/`),
          r = `    at ${m.name || i} (${e}:${m.line}:${m.column})`;
        if ((a.push(r), m.line && m.column && l < t)) {
          l++;
          try {
            let t = await Xe(p, m.source, c);
            if (t) {
              let r = e.includes(`node_modules`),
                i = /\.(tsx|jsx)$/.test(e),
                a;
              if (!r && i) {
                let e = Ze(t, m.line, m.column, n);
                e &&
                  (a = {
                    tagName: e.tagName,
                    code: e.code,
      ...
      (console.warn(`Failed to map stack line:`, e, t), a.push(e));
    }
  }
  for (let e of s.values()) e.destroy();
  let u = {
    errorMessage: e?.message || ``,
    mappedStack: a.join(`
`),
  ...
  return ((u.timestamp = Date.now()), O.set(r, u), u);
}
async function Xe(e, t, n) {
  if (n.has(t)) return n.get(t) || null;
  let r = e.sourceContentFor(t);
  return r ? (n.set(t, r), r) : null;
}
function Ze(e, t, n, r) {
  let i = e.split(`
`),
...
var Qe = class {
    ...
    (e.length > 0 &&
      e.forEach((e) => {
        e.type === `console.error`
          ? this.handleConsoleError(e.args)
          : e.type === `runtime` && this.handleError(e.args);
      }),
      (this.client = new S(window.parent)),
  ...
  interceptConsoleError() {
    console.error = (...e) => {
      ...
      let t = e.find((e) => e instanceof Error);
      if (t && t.stack) this.handleConsoleError(t);
      else if (e.length > 0) {
        let t = e
            .map((e) => (typeof e == `object` ? JSON.stringify(e) : String(e)))
            .join(` `),
...
function $e() {
  let e = new Qe();
  return ((window.runtimeErrorCollector = e), e);
}

// ============================================================
// SECTION 6: Preview Navigation & DOM-Ready Signaling
// Normalises preview URLs, signals DOMContentLoaded to parent,
// and patches window.history push/replace/go for the preview.
// ============================================================
var et = class {
  constructor() {
    ((this._client = new S(window.parent)), this._domContentLoadedListener());
  }
...
var nt = (e) => {
  let t = `/preview/a0b7eea1-17f5-4d3c-86a3-af989521ee2b/8085521`;
...
async function rt() {
  (await await t(
    ...
    (window.REACT_APP_ROUTER = {
      ...
      replace: (e, t, n) => {
        window.REACT_APP_NAVIGATE(e, { replace: !0, ...n });
      },
      forward: () => {
...
var it = new Promise((e) => {
    rt().then(() => {
      e(window.REACT_APP_ROUTER);
    });
  }),
  at = () => window.REACT_APP_ROUTER,
  ot = new S(window.parent),
  st = async (e, t) => {
    await ot.post(`routeWillChange`, { next: nt(e) }, t);
  };
function ct(e) {
  let t = document.querySelector(e);
...
function lt() {
  ...
  return (
    (window.open = function (t, n, r) {
      return t && typeof t == `string` && t.startsWith(`#`)
        ? (ct(t), null)
        : (e(t, `_blank`, r), null);
    }),
    () => {
...
function ut() {
  let e = async (e) => {
    ...
    if (
      n &&
      ![`#`, `javascript:void(0)`, ``].includes(n) &&
      !n.startsWith(`#`)
    ) {
      if ((e.preventDefault(), n.startsWith(`/`))) {
        let e = at();
        await st(n, { timeout: 500 });
        let t = nt(n);
        e.push(t);
        return;
      }
...
var dt = (e) => e.startsWith(`http://`) || e.startsWith(`https://`);
function ft(e) {
  return !e || typeof e != `string`
    ? !1
    : e.indexOf(`accounts.google.com`) !== -1 ||
        e.indexOf(`googleapis.com/oauth`) !== -1 ||
        (e.indexOf(`/auth/`) !== -1 && e.indexOf(`provider=google`) !== -1);
}
function pt() {
  let e = () => {
    let e = at(),
    ...
    e.push = async function (e, n, r) {
      return dt(e)
        ...
        : (await st(e, { timeout: 500 }), t.call(this, e, n, r));
    };
    let n = e.replace;
    e.replace = async function (e, t, r) {
      return dt(e)
        ? (window.open(e, `_blank`), Promise.resolve(!1))
        : (await st(e, { timeout: 500 }), n.call(this, e, t, r));
    };
  };
  return (
...
function mt() {
  ...
  let e = (e) => {
    ft(e.destination.url) &&
      ot.post(`google-auth-blocked`, { url: e.destination.url || `` });
  };
  return (
...
async function gt() {
  let e = await t(
      () => import(`./config.js`).then((e) => e.t).then((e) => e.default),
      [],
    ).catch((e) => []),
    n = [],
    r = 0;
  function i(e, t) {
    ...
    (/\*/.test(f.path) || n.push(f), o && o.forEach((e) => i(e, f)));
  }
  e.forEach((e) => i(e, { id: 0, path: ``, parentId: 0 }));
  let a = new Set();
  return ((n = n.filter((e) => (a.has(e.path) ? !1 : (a.add(e.path), !0)))), n);
}
async function _t() {
  let e = new S(window.parent),
    t = await gt();
  ((window.REACT_APP_ROUTES = t),
    e.post(`routes`, { routes: t }),
  ...
  function r() {
    let t = new MutationObserver((t) => {
        t.forEach((t) => {
          (t.type === `childList` || t.type === `characterData`) &&
    ...
    return (
      e.post(`titleChanged`, { title: document.title }),
      n && t.observe(n, { childList: !0, characterData: !0, subtree: !0 }),
      t
    );
  }
  let i = r();
  ...
  return (
    (window.history.pushState = function (e, t, r) {
      (o.apply(this, arguments), n(), a());
    }),
    (window.history.replaceState = function (e, t, r) {
      (s.apply(this, arguments), n(), a());
    }),
...
i((e, t) => {
  ...
  // ============================================================
  // SECTION 7: React Fiber Inspection + Readdy Feedback Widget
  // Utilities to read React fiber internals and detect event handlers.
  // Kt(): the floating Readdy watermark / feedback button UI.
  // ============================================================
})();
var yt = n(o(), 1),
  bt = n(c(), 1),
  ...
  Dt = (e, t) => {
    try {
      Ct.set(e, t);
      let n = xt.getFiberFromDOMNode(e);
      n && St.set(n, t);
    } catch {}
  },
  Ot = (e, t) => {
    if (!e)
      return (e) => {
        e instanceof HTMLElement && Dt(e, t);
      };
    if (typeof e == `function`) {
      let n = Tt.get(e);
      (n || ((n = []), Tt.set(e, n)), n.push(t));
      let r = wt.get(e);
      return (
        r ||
          ((r = (t) => {
...
function kt() {
  let e = bt.createElement,
    ...
    a = (e) => typeof e == `string`;
  ((bt.default.createElement = function (t, n, ...r) {
    if (!a(t) && typeof t != `function`) return e(t, n, ...r);
    let o = i(),
      s = n ? { ...n } : {},
      c = Ot(s.ref, o);
    return (c && (s.ref = c), e(t, s, ...r));
  }),
    r(yt, `jsx`, function (e, n, r) {
      if (!a(e) && typeof e != `function`) return t(e, n, r);
      let o = i(),
        s = n ? { ...n } : {},
        c = Ot(s.ref, o);
      return (c && (s.ref = c), t(e, s, r));
    }),
    r(yt, `jsxs`, function (e, t, r) {
      if (!a(e) && typeof e != `function`) return n(e, t, r);
      let o = i(),
        s = t ? { ...t } : {},
        c = Ot(s.ref, o);
      return (c && (s.ref = c), n(e, s, r));
    }));
}
function At(e) {
  let t = document.querySelector(e);
  ...
  let n = t.tagName.toLowerCase(),
    r = Ct.get(t);
  if (r) return { element: t, tagName: n, debugError: r() };
  let i = xt.getFiberFromDOMNode(t);
  if (i) {
    let e = St.get(i);
    if (e) return { element: t, tagName: n, debugError: e() };
  }
  return null;
}
kt();
function jt() {
  let e = new WeakMap(),
    t = new S(window.parent);
  return (
    t.on(`get-element-source`, async ({ selector: t }) => {
      let n = At(t);
      if (!n) return null;
      let { element: r, tagName: i, debugError: a } = n;
      if (e.has(r)) return e.get(r);
      let o = await Ye(a, 10, i);
      if (!o) return null;
      let s = {
...
Mt();
var Nt = `phc_V7JMHB0fVJGRu8UHyrsj6pSL1BS76P5zD8qCi7lrTTV`,
  A = {
    colors: {
      text: `#5D5D5D`,
      white: `#FFFFFF`,
  ...
  Lt = () => navigator.language?.toLowerCase().startsWith(`zh`) ?? !1,
  Rt = () => (Lt() ? It.zh : It.en),
  zt = () => window.innerWidth > 768 && !(`ontouchstart` in window),
  Bt = () => {
...
function Ht(e, t) {
  window.posthog?.capture(e, { ...t, version: 2 });
}
function Ut(e, t) {
...
function Wt(e, t = `0`) {
  Ut(e, {
    ...
    fontSize: A.font.size.normal,
    lineHeight: A.font.lineHeight,
...
function Kt() {
  ...
  async function e(e) {
    try {
      return !(
        await (
          await fetch(
            `https://readdy.ai/api/public/user/is_free?projectId=${e}`,
  ...
  function t() {
    ...
    ((e.type = `image/png`),
      (e.rel = `icon`),
      (e.href = Ft.readdyLogo),
      document.head.appendChild(e));
    let t = document.createElement(`link`);
    ((t.rel = `stylesheet`),
      (t.href = Ft.fontStylesheet),
      document.head.appendChild(t));
  }
  function n(e) {
    (Ht(e), window.open(Ft.readdyLink, `_blank`));
  }
  function r() {
    ...
    return (
      (t.src = Pt.close),
      Ut(t, { width: `24px`, height: `24px` }),
      e.appendChild(t),
      e.addEventListener(`click`, (e) => {
        (e.stopPropagation(),
          Ht(`watermark_close_button_click`),
  ...
  function i(e) {
    ...
    ((r.src = Pt.generate),
      Ut(r, { width: `16px`, height: `16px`, flexShrink: `0` }));
    let i = document.createElement(`span`);
    return (
      (i.textContent = Rt().button),
      Ut(i, {
        color: A.colors.white,
        fontFamily: A.font.family,
        fontSize: A.font.size.button,
        fontWeight: A.font.weight,
        lineHeight: A.font.lineHeight,
      }),
      t.append(r, i),
      t.addEventListener(`click`, (e) => {
        (e.stopPropagation(), n(`watermark_create_button_click`));
      }),
      t
    );
  }
  ...
  function o(e) {
    ...
    ((n.textContent = t.prefix), Wt(n));
    let r = a(),
      o = document.createElement(`div`);
    ((o.textContent = t.suffix), Wt(o, `12px`), e.append(n, r, o, i(!0)));
  }
  function s(e, t) {
    let n = document.createElement(`div`);
    return ((n.textContent = e), Wt(n), t && Ut(n, t), n);
  }
  function c(e) {
    let { prefix: t, suffix: n } = Rt(),
      [r, o] = n.startsWith(`.`) ? [`.`, n.slice(1).trim()] : [``, n],
      c = document.createElement(`div`);
    (Gt(c),
      (c.style.marginBottom = `4px`),
      c.append(s(t, { marginRight: `6px` }), a(), ...(r ? [s(r)] : [])),
      e.append(c, s(o, { textAlign: `center`, marginBottom: `12px` }), i(!1)));
  }
  function l() {
    let e = zt(),
    ...
    return (
      ...
      e ? o(t) : c(t),
      t.addEventListener(`click`, (e) => {
        e.target.closest(`#generate-button, #close-button`) ||
  ...
  function u(e) {
    ...
    !n && !e
      ? (document.body.appendChild(l()), t(), Vt())
      : e && n && n.remove();
  }
  e(`a0b7eea1-17f5-4d3c-86a3-af989521ee2b`).then(u);
}
Kt();
var j = (e) => typeof e == `string`,
  qt = () => {
    let e,
      ...
      // Deferred promise factory, HTML entity map, misc helpers used
      // by the bundled libraries below.
      // ============================================================
      t,
      n = new Promise((n, r) => {
        ((e = n), (t = r));
  ...
  Xt = /###/g,
  Zt = (e) => (e && e.indexOf(`###`) > -1 ? e.replace(Xt, `.`) : e),
  Qt = (e) => !e || j(e),
  $t = (e, t, n) => {
    let r = j(t) ? t.split(`.`) : t,
      i = 0;
  ...
  fn = (e, t, n) => {
    ((t ||= ``), (n ||= ``));
    let r = un.filter((e) => t.indexOf(e) < 0 && n.indexOf(e) < 0);
  ...
  pn = (e, t, n = `.`) => {
    ...
    // ============================================================
    // SECTION 9: i18next + i18next-browser-languagedetector
    // Full i18next internals: ResourceStore, Translator, Interpolator,
    // PluralResolver, Formatter, BackendConnector, LanguageDetector.
    // ============================================================
    return i;
  },
  mn = (e) => e?.replace(`_`, `-`),
  ...
  vn = class extends _n {
    ...
    getResource(e, t, n, r = {}) {
      ...
      return (
        ...
        s || !a || !j(n) ? s : pn(this.data?.[e]?.[t], n, i)
      );
    }
...
function xn() {
  ...
  return (
    (t.get = (r, i) => (
      n?.revoke?.(),
      i === bn ? e : (e.push(i), (n = Proxy.revocable(r, t)), n.proxy)
    )),
...
var Cn = {},
  wn = (e) => !j(e) && typeof e != `boolean` && typeof e != `number`,
  Tn = class e extends _n {
    constructor(e, t = {}) {
      (super(),
        Yt(
          [
        ...
        this.options.keySeparator === void 0 &&
          (this.options.keySeparator = `.`),
        (this.logger = gn.create(`translator`)));
    }
    changeLanguage(e) {
      e && (this.language = e);
    }
    ...
    translate(t, n, r) {
      ...
      let p = this.resolve(t, i),
        ...
        ee =
          i.ordinal && b
            ...
            : ``,
        te = b && !i.ordinal && i.count === 0,
        ne =
          (te && i[`defaultValue${this.options.pluralSeparator}zero`]) ||
          i[`defaultValue${S}`] ||
          i[`defaultValue${ee}`] ||
          i.defaultValue,
        C = m;
      y && !m && x && (C = ne);
      let re = wn(C),
        ie = Object.prototype.toString.apply(C);
      if (y && C && re && _.indexOf(ie) < 0 && !(j(v) && Array.isArray(C))) {
        if (!i.returnObjects && !this.options.returnObjects) {
          ...
          let e = this.options.returnedObjectHandler
            ? this.options.returnedObjectHandler(h, C, { ...i, ns: c })
            ...
            if (Object.prototype.hasOwnProperty.call(C, e)) {
              ...
              (x && !m
                ? (t[e] = this.translate(r, {
                    ...i,
                    defaultValue: wn(ne) ? ne[e] : void 0,
                    joinArrays: !1,
                    ns: c,
                  }))
        ...
        let e = !1,
          n = !1;
        (!this.isValidLookup(m) && x && ((e = !0), (m = ne)),
        ...
        let a =
            ...
            n
              ? void 0
              : m,
          c = x && ne !== m && this.options.updateMissing;
        if (n || e || c) {
          if (
            (this.logger.log(
  ...
  En = class {
    constructor(e) {
      ((this.options = e),
        ...
        (this.logger = gn.create(`languageUtils`)));
    }
  ...
  Dn = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
  On = {
  ...
  kn = class {
    constructor(e, t = {}) {
      ((this.languageUtils = e),
        (this.options = t),
        (this.logger = gn.create(`pluralResolver`)),
    ...
    getSuffixes(e, t = {}) {
      ...
      return (
        ...
        n
          ? n
              .resolvedOptions()
              .pluralCategories.sort((e, t) => Dn[e] - Dn[t])
              .map(
                (e) =>
  ...
  An = (e, t, n, r = `.`, i = !0) => {
    let a = rn(e, t, n);
    return (
      !a && i && j(n) && ((a = pn(e, n, r)), a === void 0 && (a = pn(t, n, r))),
      a
    );
  },
  jn = (e) => e.replace(/\$/g, `$$$$`),
  Mn = class {
    constructor(e = {}) {
      ((this.logger = gn.create(`interpolator`)),
        (this.options = e),
    ...
    interpolate(e, t, n, r) {
      ...
      return (
        [
          { regex: this.regexpUnescape, safeValue: (e) => jn(e) },
          {
            regex: this.regexp,
            safeValue: (e) => (this.escapeValue ? jn(this.escape(e)) : jn(e)),
          },
        ].forEach((t) => {
            ...
            if (((a = c(n)), a === void 0))
              if (typeof l == `function`) {
                ...
                (this.logger.warn(
                  ...
                  (a = ``));
            else !j(a) && !this.useRawValueToEscape && (a = Jt(a));
            let s = t.safeValue(a);
            if (
              ((e = e.replace(i[0], s)),
              u
  ...
  Pn = (e) => {
    ...
    return (n, r, i) => {
      ...
      let o = r + JSON.stringify(a),
        s = t[o];
      return (s || ((s = e(mn(r), i)), (t[o] = s)), s(n));
    };
  },
  Fn = (e) => (t, n, r) => e(mn(n), r)(t),
  In = class {
    constructor(e = {}) {
      ((this.logger = gn.create(`formatter`)),
        (this.options = e),
        this.init(e));
    }
    init(e, t = { interpolation: {} }) {
      this.formatSeparator = t.interpolation.formatSeparator || `,`;
      let n = t.cacheInBuiltFormats ? Pn : Fn;
      this.formats = {
        number: n((e, t) => {
    ...
    addCached(e, t) {
      this.formats[e.toLowerCase().trim()] = Pn(t);
    }
    format(e, t, n, r = {}) {
      ...
      return i.reduce((e, t) => {
        let { formatName: i, formatOptions: a } = Nn(t);
        if (this.formats[i]) {
          let t = e;
          try {
  ...
  Rn = class extends _n {
    constructor(e, t, n, r = {}) {
      (super(),
        ...
        (this.options = r),
        (this.logger = gn.create(`backendConnector`)),
        (this.waitingReads = []),
  ...
  Un = class e extends _n {
    ...
    init(e = {}, t) {
      ...
      let n = zn();
      ((this.options = { ...n, ...this.options, ...Bn(e) }),
        (this.options.interpolation = {
          ...n.interpolation,
          ...this.options.interpolation,
        }),
      ...
      if (!this.options.isClone) {
        this.modules.logger
          ? gn.init(r(this.modules.logger), this.options)
          : gn.init(null, this.options);
        let e;
        e = this.modules.formatter ? this.modules.formatter : In;
        let t = new En(this.options);
        this.store = new vn(this.options.resources, this.options);
        let i = this.services;
        ((i.logger = gn),
          (i.resourceStore = this.store),
          (i.languageUtils = t),
          (i.pluralResolver = new kn(t, {
          ...
          (i.interpolator = new Mn(this.options)),
          (i.utils = {
            hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
          }),
          (i.backendConnector = new Rn(
          ...
          (this.translator = new Tn(this.services, this.options)),
    ...
    use(e) {
      ...
      return (
        ...
        e.type === `postProcessor` && yn.addPostProcessor(e),
    ...
    dir(e) {
      ...
      let t =
        ...
        n = this.services?.languageUtils || new En(zn());
    ...
    cloneInstance(t = {}, n = Vn) {
      ...
      return (
        ...
        (a.translator = new Tn(a.services, i)),
        a.translator.on(`*`, (e, ...t) => {
          a.emit(e, ...t);
        }),
        a.init(i, n),
  ...
  Wn = Un.createInstance();
((Wn.createInstance = Un.createInstance),
  Wn.createInstance,
  Wn.dir,
  Wn.init,
  Wn.loadResources,
  ...
  Wn.t,
  Wn.exists,
  Wn.setDefaultNamespace,
  Wn.hasLoadedNamespace,
  Wn.loadNamespaces,
  Wn.loadLanguages);
var Gn =
  ...
  Zn = (0, bt.createContext)();
function Qn({ i18n: e, defaultNS: t, children: n }) {
  let r = (0, bt.useMemo)(() => ({ i18n: e, defaultNS: t }), [e, t]);
  return (0, bt.createElement)(Zn.Provider, { value: r }, n);
}
var { slice: $n, forEach: er } = [];
function tr(e) {
  return (
    er.call($n.call(arguments, 1), (t) => {
...
var rr = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
  ir = function (e, t) {
    ...
    if (n.domain) {
      if (!rr.test(n.domain)) throw TypeError(`option domain is invalid`);
      r += `; Domain=${n.domain}`;
    }
    if (n.path) {
      if (!rr.test(n.path)) throw TypeError(`option path is invalid`);
      r += `; Path=${n.path}`;
    }
    if (n.expires) {
  ...
  or = {
    ...
    lookup(e) {
      ...
      if (t && typeof document < `u`) return ar.read(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      ...
      n && typeof document < `u` && ar.create(n, e, r, i, a);
    },
  },
  sr = {
    name: `querystring`,
  ...
  dr = {
    ...
    lookup(e) {
      ...
      if (t && ur()) return window.localStorage.getItem(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      let { lookupLocalStorage: n } = t;
      n && ur() && window.localStorage.setItem(n, e);
    },
  },
  fr = null,
  pr = () => {
  ...
  mr = {
    ...
    lookup(e) {
      ...
      if (t && pr()) return window.sessionStorage.getItem(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      let { lookupSessionStorage: n } = t;
      n && pr() && window.sessionStorage.setItem(n, e);
    },
  },
  hr = {
    name: `navigator`,
...
var xr = () => ({
  ...
  Sr = class {
    ...
    init() {
      ...
      ((this.services = e),
        (this.options = tr(t, this.options || {}, xr())),
...
(Object.keys(Cr).forEach((e) => {
  ...
  if (t) {
    let [, n] = t,
      r = Cr[e];
    (wr[n] || (wr[n] = { translation: {} }),
      r.default &&
        (wr[n].translation = { ...wr[n].translation, ...r.default }));
  }
}),
  Wn.use(Sr)
    .use(Xn)
...
var Tr = Wn,
  Er = i((e) => {
    function t(e, t) {
      ...
      // ============================================================
      // SECTION 10: React Scheduler
      // Task scheduling via MessageChannel / setTimeout fallback.
      // scheduleCallback, cancelCallback, shouldYield, etc.
      // ============================================================
      a: for (; 0 < n; ) {
        var r = (n - 1) >>> 1,
          a = e[r];
  ...
  Or = i((e) => {
    ...
    var i = {
        d: {
          ...
          // ============================================================
          // SECTION 11: React DOM (react-dom/client)
          // Full React DOM reconciler, hooks, event system, hydration,
          // Suspense, concurrent features, createRoot, hydrateRoot.
          // ============================================================
          r: function () {
            throw Error(n(522));
          },
  ...
  Ar = i((e) => {
    ...
    function xe(e) {
      (he.current === e && (E(me), E(he)),
        _e.current === e && (E(_e), (Qf._currentValue = ue)));
    }
    var Se, Ce;
    function we(e) {
      if (Se === void 0)
...
` +
    ...
    function We(e) {
      if (
        ...
        O && typeof O.setStrictMode == `function`)
      )
        try {
          O.setStrictMode(Ue, e);
        } catch {}
    }
    ...
    var Or = typeof Object.is == `function` ? Object.is : Er;
    function Ar(e, t) {
      if (Or(e, t)) return !0;
    ...
    var Ir = mn && `documentMode` in document && 11 >= document.documentMode,
      Lr = null,
      Rr = null,
      zr = null,
      Br = !1;
    ...
    var Rl = {
      ...
      fu = null;
    function pu() {
      return G & 2 && J !== 0 ? J & -J : w.T === null ? dt() : dd();
    }
    function mu() {
      if (Jl === 0)
        if (!(J & 536870912) || N) {
    ...
    function Bu() {
      if (iu === 4 || iu === 3) {
        ...
        if (
          ...
          ut(n),
          (t = t.stateNode),
          O && typeof O.onCommitFiberRoot == `function`)
        )
          try {
            O.onCommitFiberRoot(Ue, t, void 0, (t.current.flags & 128) == 128);
          } catch {}
        if (r !== null) {
...
`,
    ...
    e.createRoot = function (e, t) {
      ...
      // App routes, i18n provider, React.StrictMode root render.
      // ============================================================
    };
  }),
  jr = i((e, t) => {
  ...
  Mr = l({ AppRoutes: () => Fr, navigatePromise: () => Pr }),
  Nr,
  Pr = new Promise((e) => {
    Nr = e;
  });
function Fr() {
  ...
  return (
    (0, bt.useEffect)(() => {
      ((window.REACT_APP_NAVIGATE = n), Nr(window.REACT_APP_NAVIGATE));
    }),
    t
  );
}
function Ir() {
  return (0, yt.jsx)(Qn, {
    ...
    children: (0, yt.jsx)(s, {
      basename: ``,
      children: (0, yt.jsx)(Fr, {}),
    }),
  });
}
(0, jr.createRoot)(document.getElementById(`root`)).render(
  (0, yt.jsx)(bt.StrictMode, { children: (0, yt.jsx)(Ir, {}) }),
);
//# sourceMappingURL=index-Ds2zPHcR.js.map
